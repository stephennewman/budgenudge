-- SMS Deduplication System Migration
-- Run this SQL in Supabase Dashboard > SQL Editor

-- 1. Create SMS send tracking table
...
-- 2. Add unique constraint for deduplication (prevents duplicate SMS per day)
...
-- 6. Create deduplication check function
...
-- 9. Test the functions (optional - just to verify they work)
SELECT public.can_send_sms('+16173472721', 'test') AS can_send_test;